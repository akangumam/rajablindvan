...
<div class="settings-page-layout">
    ...
    <div class="settings-page-content">
        ...
        @endif
            ...
            {{-- Upload Form Section - HIDDEN: Files are uploaded from their respective pages (Fuel, Expense, Income, Service)
            <!-- Upload Form Section -->
            ...
            <div class="storage-field">
                <label class="storage-field-label">Total Storage Usage</label>
                <div class="storage-usage">
                    ...
                    <div class="storage-legend" style="margin-top: 15px; display: flex; flex-wrap: wrap; gap: 15px;">
                        <div class="legend-item" style="display: flex; align-items: center; gap: 8px;">
                            ...
                            <span style="font-size: 13px; color: #666;">Fuel ({{ number_format($categoryStats['fuel']['size'], 2) }} MB)</span>
                        </div>
                        <div class="legend-item" style="display: flex; align-items: center; gap: 8px;">
                            <span style="width: 16px; height: 16px; background: #ff5722; border-radius: 3px; display: inline-block;"></span>
                            <span style="font-size: 13px; color: #666;">Expense ({{ number_format($categoryStats['expense']['size'], 2) }} MB)</span>
                        </div>
                        <div class="legend-item" style="display: flex; align-items: center; gap: 8px;">
                            <span style="width: 16px; height: 16px; background: #4caf50; border-radius: 3px; display: inline-block;"></span>
                            <span style="font-size: 13px; color: #666;">Income ({{ number_format($categoryStats['income']['size'], 2) }} MB)</span>
                        </div>
                        <div class="legend-item" style="display: flex; align-items: center; gap: 8px;">
                            <span style="width: 16px; height: 16px; background: #795548; border-radius: 3px; display: inline-block;"></span>
                            <span style="font-size: 13px; color: #666;">Service ({{ number_format($categoryStats['service']['size'], 2) }} MB)</span>
                        </div>
                        <div style="display: flex; align-items: center; gap: 10px;">
                            <div style="width: 16px; height: 16px; background: #2196f3; border-radius: 3px;"></div>
                            <span style="font-size: 13px; color: #666;">Vehicle ({{ number_format($categoryStats['vehicle']['size'], 2) }} MB)</span>
                        </div>
                        <div class="legend-item" style="display: flex; align-items: center; gap: 8px;">
                            <span style="width: 16px; height: 16px; background: #e9ecef; border-radius: 3px; display: inline-block; border: 1px solid #dee2e6;"></span>
                            <span style="font-size: 13px; color: #666;">Unused ({{ number_format($unusedMB, 2) }} MB)</span>
                        </div>
                    </div>
                </div>
            </div>
