...
<div id="vehicleModal" class="vehicle-modal">
    <div class="vehicle-modal-content">
        ...
        <div class="vehicle-modal-search" style="position: relative;">
            ...
            <input type="text" id="vehicleSearch" class="vehicle-search-input" placeholder="Cari Nama atau No Plat..." style="padding-left: 40px; padding-right: 40px;" onkeyup="filterVehicles()" autofocus>
            <button type="button"
